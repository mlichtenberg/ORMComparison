...
namespace CustomDataAccess
{
    ...
    public class CustomSqlHelper
    {
        ...
        /*
         THE FOLLOWING ADDED TO SUPPORT DATAACCESSNOSP APPROACH
         */
        public static SqlCommand CreateCommand(string procedure, SqlConnection connection, CommandType commandType)
        {
            return createCommand(procedure, connection, null, commandType);
        }
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static SqlCommand CreateCommand(string procedure, SqlConnection connection, SqlTransaction transaction, CommandType commandType, params SqlParameter[] parameters)
        {
            return createCommand(procedure, connection, transaction, commandType, parameters);
        }

        private static SqlCommand createCommand(string procedure, SqlConnection connection, SqlTransaction transaction, CommandType commandType, params SqlParameter[] parameters)
        {
            SqlCommand command = new SqlCommand();
        ...
        /*
         END ADDITION FOR DATAACCESSNOSP APPROACH
         */
